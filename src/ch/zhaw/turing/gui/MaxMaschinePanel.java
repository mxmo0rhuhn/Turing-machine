...
public class MaxMaschinePanel extends JPanel implements Observer {
    ...
    private void zeichneBandElement(Graphics g) {
        ...
        int topOffset = MaxMaschinePanel.topOffset + elemHeight;
        ...
        for (int j = 0; j < curTape.length; j++) {
            int leftOffset = (j + 1) * MaxMaschinePanel.leftOffset + j * elemWidth;
